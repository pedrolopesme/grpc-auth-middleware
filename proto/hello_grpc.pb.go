...
type HelloHandlerClient interface {
	SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloHandlerClient) SayHello(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*HelloResponse, error) {
...
type HelloHandlerServer interface {
	SayHello(context.Context, *Hello) (*HelloResponse, error)
...
func (UnimplementedHelloHandlerServer) SayHello(context.Context, *Hello) (*HelloResponse, error) {
...
func _HelloHandler_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloHandlerServer).SayHello(ctx, req.(*Hello))
	}
